<template>
  <div class="relative w-[360px] h-[58px] bg-white flex items-center justify-center px-5">
    <ul class="flex justify-between w-full relative">
      ...
      <!-- Moving Indicator -->
      <li class="absolute top-[6px] left-[-22px] transition-transform duration-300 z-0"
...
const indicatorX = computed(() => {
  return activeIndex.value + activeIndex.value * 82; // 70px width + ~12px spacing
});
</script>
